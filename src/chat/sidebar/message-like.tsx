...
const ThumbUpFilled = ({ className }: { className?: string }) => (
...
const ThumbUpOutline = ({ className }: { className?: string }) => (
...
const ThumbDownFilled = ({ className }: { className?: string }) => (
  <svg className={className} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
...
const ThumbDownOutline = ({ className }: { className?: string }) => (
  <svg className={className} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
export const MessageLike = observer(({ chatMessage, className }: Props) => {

  const [liked, setLiked] = useState(0)

  const onThumb = (direction: number) => {
