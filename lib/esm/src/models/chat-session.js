    ...
    return _a = class ChatSessionModel extends _classSuper {
            ...
            constructor() {
                ...
                Object.defineProperty(this, "fetchState", {
                    ...
                    configurable: true,
                    writable: true,
                    value: (__runInitializers(this, _email_extraInitializers), __runInitializers(this, _fetchState_initializers, FetchModel.create()))
                });
                Object.defineProperty(this, "saveState", {
                    enumerable: true,
                    configurable: true,
                    writable: true,
                    value: (__runInitializers(this, _fetchState_extraInitializers), __runInitializers(this, _saveState_initializers, FetchModel.create()))
                });
        ...
        (() => {
            ...
            _nexaiApiKey_decorators = [observable];
            _sessionId_decorators = [observable];
            _name_decorators = [observable];
            _isShowChat_decorators = [observable];
            _avatarUrl_decorators = [observable];
            _email_decorators = [observable];
            _fetchState_decorators = [observable];
            _fetch_decorators = [action];
            _saveState_decorators = [observable];
            _save_decorators = [action];
