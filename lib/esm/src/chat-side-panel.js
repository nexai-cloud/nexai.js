...
export const ChatSidePanel = ({ nexaiApiKey, nexaiApiUrl = 'https://nexai.site/api', }) => {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs(ResizablePanelGroup, { direction: "horizontal", className: cn('fixed bottom-0 left-0 pointer-events-none', !isSidePanel && 'md:p-10 md:pb-20'), children: [_jsx(ResizablePanel, { className: cn('flex flex-col space-y-2 space-x-2 p-3', 'hidden lg:flex'), defaultSize: 70 }), open && (_jsx(ResizableHandle
