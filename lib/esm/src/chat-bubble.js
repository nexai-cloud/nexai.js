...
export const NexaiChatBubble = observer(({ width = 380, nexaiApiKey, nexaiIoUrl = 'https://ai-chat-server-production.up.railway.app', nexaiAssetsUrl = 'https://nexai.site/ai/assets', aiName = 'Nexai', aiAvatarUrl = '', chatSuggests = [], projectName = 'Nexai', inputPlaceholder = '' }) => {
