...
export const NexaiChatBubble = observer(({ width = 380, nexaiApiKey, nexaiIoUrl = 'http://localhost:8080', nexaiAssetsUrl = '', aiName = 'Nexai', aiAvatarUrl = '', chatSuggests = [], projectName = 'Nexai', inputPlaceholder = '' }) => {
    ...
    const addAITyping = useCallback(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const thread = Object.assign(Object.assign({}, getAiUser({ aiName, aiAvatarUrl, nexaiAssetsUrl })), { uid, hide: false, date: new Date(), isTyping: true, messages: [{
                    uid: randomUUID(),
                    isTyping: true,
