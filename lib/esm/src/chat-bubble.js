...
export const NexaiChatBubble = observer(({ width = 380, nexaiApiKey, nexaiIoUrl = 'https://chat.nexai.site', nexaiAssetsUrl = 'https://nexai.site/ai/assets', aiName = 'Nexai', aiAvatarUrl = 'https://nexai.site/ai/logo/nexai-logo-round.svg', chatSuggests = [
