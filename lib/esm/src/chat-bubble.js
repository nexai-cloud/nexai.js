...
export const NexaiChatBubble = observer(({ width = 400, nexaiApiKey, nexaiIoUrl = 'https://io.nexai.site', nexaiAssetsUrl = 'https://nexai.site/ai/assets', aiName = 'AI Assistant', aiAvatarUrl = '', chatSuggests = [], projectName = 'AI Support', inputPlaceholder = 'Ask a question...' }) => {
    const [isShowChat, setIsShowChat] = useState(Boolean(hasIsShowChat() ? getIsShowChat() : true));
