...
export const MessageLike = observer(({ chatMessage, className }) => {
    ...
    return (_jsxs("div", { className: cn("chat-message-like flex gap-2 m-2", className), children: [_jsx(TooltipWrap, { className: "bg-white text-slate-700", tooltip: 'Like', children: _jsx("div", { onClick: () => onThumb(1), children: liked > 0 ? _jsx(ThumbUpFilled, {}) : _jsx(ThumbUpOutline, {}) }) }), _jsx(TooltipWrap, { className: "bg-white text-slate-700", tooltip: 'Unlike', children: _jsx("div", { onClick: () => onThumb(-1), children: liked < 0 ? _jsx(ThumbDownFilled, {}) : _jsx(ThumbDownOutline, {}) }) })] }));
});
