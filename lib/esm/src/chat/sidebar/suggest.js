...
export const SearchSuggest = observer(({ nexaiApiKey, nexaiApiUrl, input, onMenuItemSelect, showInput = true }) => {
    ...
    if (!input)
        return null;
    return (_jsxs(_Fragment, { children: [_jsx(ScrollArea, { className: cn(!visibleNav.length && 'hidden', 'p-2'), children: _jsxs(CommandList, { className: "overflow-visible", children: [_jsx(CommandGroup, { heading: (_jsx("p", { className: "text-blue-500 text-sm flex", children: 'Suggestions' })), children: _jsxs(CommandItem, { value: input, className: cn(!showInput && "hidden", "cursor-pointer group items-center", "aria-selected:bg-blue-100 "), children: [_jsx("div", { className: "mr-2 ml-2 flex h-4 w-4 items-center justify-center", children: _jsx(SparklesIcon, { className: "text-yellow-500 h-3 w-3" }) }), _jsxs("span", { className: "flex items-center text-muted-foreground", children: [input, "..."] }), _jsx("span", { className: "opacity-0 item-arrow ml-auto mr-2 h-6 w-6 items-center justify-center group group-aria-selected:opacity-100", children: _jsx(SparklesIcon, { className: "text-blue-500 h-6 w-6 mb-2" }) })] }) }), visibleNav.map((group, i) => {
                            var _a;
                            return group && (_jsx(CommandGroup, { heading: (_jsx("p", { className: "text-blue-500", children: group.title })), children: (_a = group.items) === null || _a === void 0 ? void 0 : _a.map((navItem, i) => (_jsxs(CommandItem, { value: navItem.title, onSelect: () => onSelect(navItem), className: cn("cursor-pointer group items-center", "aria-selected:bg-blue-100 "), children: [_jsx("div", { className: "mr-2 ml-2 flex h-4 w-4 items-center justify-center", children: group.icon ? (_jsx("span", { className: "text-blue-500", children: group.icon })) : (_jsx(LucideMessageCircleQuestion, { className: "text-blue-500 h-5" })) }), _jsx("span", { className: "text-slate-700", children: navItem.title }), _jsx("span", { className: "opacity-0 item-arrow ml-auto mr-2 h-6 w-6 items-center justify-center group group-aria-selected:opacity-100", children: _jsx(ChevronRight, { className: "text-blue-500 h-6 w-6 mb-2" }) })] }, i))) }, i));
