...
export const MessageCopy = observer(({ chatMessage, className }) => {
    ...
    return (_jsx("div", { className: cn("chat-message-like flex gap-2 m-2", className), children: _jsx(TooltipWrap, { className: "bg-white", tooltip: isCopied ? 'Message Copied' : 'Copy Message', children: _jsx("div", { onClick: () => onCopy(), children: isCopied ? _jsx(CopyFilled, {}) : _jsx(CopyOutline, {}) }) }) }));
});
