...
let FetchModel = (() => {
    ...
    return _a = class FetchModel extends _classSuper {
        ...
        (() => {
            ...
            _busy_decorators = [mobx_1.observable];
            _ok_decorators = [mobx_1.observable];
            _startDate_decorators = [mobx_1.observable];
            _endDate_decorators = [mobx_1.observable];
            _get_fetched_decorators = [mobx_1.computed];
