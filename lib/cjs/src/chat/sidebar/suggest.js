...
exports.SearchSuggest = (0, mobx_react_lite_1.observer)(({ nexaiApiKey, nexaiApiUrl, input, onMenuItemSelect, showInput = true }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(scroll_area_1.ScrollArea, { className: (0, utils_1.cn)(!visibleNav.length && 'hidden', 'p-2'), children: (0, jsx_runtime_1.jsxs)(command_1.CommandList, { className: "overflow-visible", children: [(0, jsx_runtime_1.jsx)(command_1.CommandGroup, { heading: ((0, jsx_runtime_1.jsx)("p", { className: "text-blue-500 text-sm flex", children: 'Suggestions' })), children: (0, jsx_runtime_1.jsxs)(command_1.CommandItem, { className: (0, utils_1.cn)(!showInput && "hidden", "cursor-pointer group items-center", "aria-selected:bg-blue-100 "), children: [(0, jsx_runtime_1.jsx)("div", { className: "mr-2 ml-2 flex h-4 w-4 items-center justify-center", children: (0, jsx_runtime_1.jsx)(lucide_react_1.ZapIcon, { className: "text-yellow-500 h-3 w-3" }) }), (0, jsx_runtime_1.jsxs)("span", { className: "flex items-center", children: [input, "..."] }), (0, jsx_runtime_1.jsx)("span", { className: "opacity-0 item-arrow ml-auto mr-2 h-6 w-6 items-center justify-center group group-aria-selected:opacity-100", children: (0, jsx_runtime_1.jsx)(lucide_react_1.PlusIcon, { className: "text-blue-500 h-6 w-6 mb-2" }) })] }) }), visibleNav.map((group) => {
                            var _a;
                            return group && ((0, jsx_runtime_1.jsx)(command_1.CommandGroup, { heading: ((0, jsx_runtime_1.jsx)("p", { className: "text-blue-500", children: group.title })), children: (_a = group.items) === null || _a === void 0 ? void 0 : _a.map((navItem) => ((0, jsx_runtime_1.jsxs)(command_1.CommandItem, { value: navItem.title, onSelect: () => onSelect(navItem), className: (0, utils_1.cn)("cursor-pointer group items-center", "aria-selected:bg-blue-100 "), children: [(0, jsx_runtime_1.jsx)("div", { className: "mr-2 ml-2 flex h-4 w-4 items-center justify-center", children: group.icon ? ((0, jsx_runtime_1.jsx)("span", { className: "text-blue-500", children: group.icon })) : ((0, jsx_runtime_1.jsx)(react_icons_1.CircleIcon, { className: "text-blue-500 h-3 w-3" })) }), (0, jsx_runtime_1.jsx)("span", { className: "", children: navItem.title }), (0, jsx_runtime_1.jsx)("span", { className: "opacity-0 item-arrow ml-auto mr-2 h-6 w-6 items-center justify-center group group-aria-selected:opacity-100", children: (0, jsx_runtime_1.jsx)(lucide_react_1.ChevronRight, { className: "text-blue-500 h-6 w-6 mb-2" }) })] }, navItem.href))) }, group.title));
