...
exports.ChatSidebar = (0, mobx_react_lite_1.observer)(({ nexaiApiKey, onClickBack, nexaiApiUrl = 'https://nexai.site/api', nexaiAssetsUrl = 'https://nexai.site/assets', nexaiIoUrl = 'https://io.nexai.site', onChatInput }) => {
    ...
    const [mountCmdk, setMountCmdk] = (0, react_1.useState)(true);
    ...
    const _onChatInput = (0, react_1.useCallback)((input) => {
        setChatInput(input);
        onChatInput && onChatInput(input);
    }, [onChatInput]);
    const DivCom = ({ children }) => ((0, jsx_runtime_1.jsx)("div", { className: (0, utils_1.cn)("h-full w-full overflow-visible"), children: children }));
    const CommandCom = mountCmdk ? command_1.Command : DivCom;
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(header_1.ChatHeader, { teamMembers: chatAssistants, onClickBack: onClickBack }), (0, jsx_runtime_1.jsx)(messages_1.Messages, { ref: messagesRef, msgs: [...messagesModel.items] }), (0, jsx_runtime_1.jsx)("div", { className: "mt-auto p-2", children: (0, jsx_runtime_1.jsxs)(CommandCom, { className: (0, utils_1.cn)("h-full w-full rounded-lg overflow-visible"), shouldFilter: false, children: [(0, jsx_runtime_1.jsx)("div", { className: "relative", children: chatInput && ((0, jsx_runtime_1.jsx)("div", { className: (0, utils_1.cn)("absolute bottom-3 left-0 z-50", "border rounded-lg mx-2 mb-0 ", "shadow-xl  shadow-slate-300 bg-slate-50 border-blue-500"), children: (0, jsx_runtime_1.jsx)(suggest_1.SearchSuggest, { input: chatInput, nexaiApiUrl: nexaiApiUrl, nexaiApiKey: nexaiApiKey, onMenuItemSelect: onSendSuggest }) })) }), (0, jsx_runtime_1.jsx)(input_1.ChatInput, { ref: chatInputRef, chatInput: chatInput, nexaiApiKey: nexaiApiKey, onChatInput: _onChatInput, onSendChatMsg: onSendChatMsg, onSpeechTranscript: onSpeechTranscript })] }) })] }));
});
