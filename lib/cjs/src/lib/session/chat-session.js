...
const getClientSession = (apiKey, nexaiAssetsUrl) => {
    if (typeof window !== "undefined") {
        let session = (0, exports.fetchSession)(apiKey);
        if (!session) {
            session = (0, exports.createSession)(nexaiAssetsUrl);
            (0, exports.saveClientSession)(apiKey, session);
        }
        return session;
    }
    else {
        return (0, exports.createSession)(nexaiAssetsUrl);
    }
};
exports.getClientSession = getClientSession;
const createSession = (nexaiAssetsUrl) => {
    const avatar = (0, random_avatar_1.randomAvatarGenerator)(nexaiAssetsUrl);
    return {
