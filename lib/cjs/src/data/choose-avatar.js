...
exports.ChooseAvatar = (0, mobx_react_lite_1.observer)(({ chatSession }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("h3", { className: "font-bold pt-4 pb-2 text-sm text-muted", children: "You may choose a profile" }), (0, jsx_runtime_1.jsx)("div", { className: 'flex gap-4 flex-wrap py-4 px-2', children: avatars_list_1.avatarsList.map((avatar, index) => ((0, jsx_runtime_1.jsx)("button", { className: (0, utils_1.cn)("rounded-full border-2 shadow-lg", avatarUrl === avatar.path
                        ? "border-blue-500"
                        : "border-transparent"), onClick: () => onSelectAvatar(avatar), children: (0, jsx_runtime_1.jsx)("img", { src: avatar.path, alt: avatar.name, className: "w-10 h-10" }) }, index))) }), (0, jsx_runtime_1.jsx)("div", { className: "flex p-2", children: (0, jsx_runtime_1.jsx)(input_1.Input, { value: chatSession.name, onChange: (e) => onChangeName(e.target.value), placeholder: "Enter your name", className: (0, utils_1.cn)("w-full", !isNameValid && "border-red-500"), onBlur: () => onBlurName() }) }), (0, jsx_runtime_1.jsx)("div", { className: "flex p-2", children: (0, jsx_runtime_1.jsx)(input_1.Input, { value: chatSession.email, onChange: (e) => onChangeEmail(e.target.value), placeholder: "Enter your email", className: (0, utils_1.cn)("w-full", !isEmailValid && "border-red-500"), type: "email", onBlur: () => onBlurEmail() }) })] }));
});
