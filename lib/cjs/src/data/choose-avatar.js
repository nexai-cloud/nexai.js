...
exports.ChooseAvatar = (0, mobx_react_lite_1.observer)(({ chatSession, nexaiAssetsUrl }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("h3", { className: "font-bold text-primary pt-4 pb-2 text-sm", children: "You may choose a profile" }), (0, jsx_runtime_1.jsx)("div", { className: 'flex gap-4 flex-wrap py-4 px-2', children: avatarsList.map((avatar, index) => ((0, jsx_runtime_1.jsx)("button", { className: (0, utils_1.cn)("rounded-full border-2 shadow-lg", avatarUrl === avatar.path
                        ? "border-blue-500"
