...
require("./chat/sidebar/style/sidebar.css");
const lucide_react_1 = require("lucide-react");
const ChatSidePanel = ({ nexaiApiKey, nexaiApiUrl, }) => {
    const [open, _setOpen] = (0, react_1.useState)(localStorage.getItem('nexai:open') === null
        ? true
        : Boolean(localStorage.getItem('nexai:open')));
    const [isSidePanel, setIsSidePanel] = (0, react_1.useState)(localStorage.getItem('nexai:panel') === null
        ? true
