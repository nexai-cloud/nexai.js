...
require("./chat-bubble.css");
require("./index.css");
require("./ui/busy-indicator/busy-indicator.css");
...
require("./ui/wave-form/wave-form.css");
...
exports.NexaiChatBubble = (0, mobx_react_lite_1.observer)(({ width = 380, nexaiApiKey, nexaiIoUrl = 'http://localhost:8080', nexaiAssetsUrl = '', aiName = 'Nexai', aiAvatarUrl = '', chatSuggests = [], projectName = 'Nexai', inputPlaceholder = '' }) => {
    ...
    const chatSession = (0, chat_session_1.useChatSessionModel)({ nexaiApiKey });
    ...
    const addAITyping = (0, react_1.useCallback)(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const thread = Object.assign(Object.assign({}, (0, chat_data_1.getAiUser)({ aiName, aiAvatarUrl, nexaiAssetsUrl })), { uid, hide: false, date: new Date(), isTyping: true, messages: [{
...
window.NexaiChatBubble = exports.NexaiChatBubble;
