...
exports.NexaiChatBubble = (0, mobx_react_lite_1.observer)(({ width = 380, nexaiApiKey, nexaiIoUrl = 'https://ai-chat-server-production.up.railway.app', nexaiAssetsUrl = 'https://nexai.site/ai/assets', aiName = 'Nexai', aiAvatarUrl = '', chatSuggests = [], projectName = 'Nexai', inputPlaceholder = '' }) => {
