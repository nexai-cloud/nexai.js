...
const apiUrl = config_1.config.nexaiLocalApiUrl;
...
sessions.on("connection", socket => {
    ...
    socket.on('chat', (msg) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (!msg.email && !sentEmailReq) {
            sentEmailReq = true;
            session.emit('chat', Object.assign(Object.assign({}, chatMsg), { uid: (0, utils_1.randomUUID)(), userUid: 'nexai', message: 'It is best to provide an email so we can contact you.' }));
        }
